...
if(isset($_POST["product_id"])){
    ...
    $sql = "SELECT * FROM cosmetic_desk c, product p, product_brand b WHERE c.product_id = p.product_id AND p.brand_id = b.brand_id AND c.user_id = '$user_id' AND c.product_id = '$product_id'";
}else{
