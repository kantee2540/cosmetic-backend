...
// 1 = Update
if ($option == '0'){
    $sql = "INSERT INTO `user` (`user_id`, `first_name`, `last_name`, `nickname`, `email`, `gender`, `birthday`, `uid`) VALUES (NULL, '$firstName', '$lastName', '$nickName', '$email', '$gender', '$birthday', '$uid ');";
}else if ($option == '1'){
